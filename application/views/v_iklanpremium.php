    ...
    <div class="container">
        ...
        <div class="span8">
            <div class="search-result" style="">
                ...
                <h4 style="text-transform: uppercase">Iklan Premium</h4>
                <hr>
                <?php
                $this->load->helper('premium_helper');
                if(!empty($iklan_premium)) {?>
                    <ul class="thumbnails">
                        <?php foreach($iklan_premium->result() as $data) { ?>
                ...
                <?php } else { ?>
                    <h4>tidak ada data untuk iklan premium <?php echo $kategori_pencarian; ?>.</h4>
                <?php } ?>
