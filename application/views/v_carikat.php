    ...
    <div class="container">
        ...
        <div class="span8">
            <div class="search-result" style="">
                ...
                <h4 style="text-transform: uppercase">Kategori <?php echo $kategori_pencarian; ?></h4>
                <hr>
                <?php
                $this->load->helper('premium_helper');
                if(!empty($search_result)) {?>
                    <ul class="thumbnails">
                        <?php foreach($search_result->result() as $data) {
                ...
                <?php } else { ?>
                    <h4>tidak ada data untuk kategori <?php echo $kategori_pencarian; ?>.</h4>
                <?php } ?>
