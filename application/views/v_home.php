...
<div class="container" style="width: 1300px">
    ...
    <div class="banner-kiri">
        <?php if(!empty($iklan_kiri)) {
                if($iklan_kiri->disetujui == 1) {
                ?>
                    <?php if(!empty($iklan_kiri->foto)) { ?>
                        <img src="<?php echo base_url();?>img_iklan/<?php echo $iklan_kiri->foto; ?>" alt="" class="img-polaroid"/>
                    <?php } else { ?>
                        <img src="holder.js/160x600" alt="" class="img-polaroid"/>
                    <?php } ?>
                <?php } ?>
...
<!--        <img src="holder.js/600x400" alt="" class="img-polaroid"/>-->
        <div class="slider-wrapper">
            <div id="slider">
                <?php if(!empty($iklan_slider)) { ?>
                <?php
                $no = 1;
                foreach($iklan_slider->result() as $data) { ?>
                <div class="slide<?php echo $no; ?>">
                    <img class="img-slider" src="<?php echo base_url();?>img_iklan/<?php echo $data->foto; ?>" alt="" class="img-polaroid"/>
                </div>
<!--                <div class="slide1">-->
<!--                    <img class="img-slider" src="img/slider/1.jpg" alt="" class="img-polaroid"/>-->
<!--                </div>-->
<!--                <div class="slide2">-->
<!--                    <img class="img-slider" src="img/slider/2.jpg" alt="" class="img-polaroid"/>-->
<!--                </div>-->
<!--                <div class="slide3">-->
<!--                    <img class="img-slider" src="img/slider/3.jpg" alt="" class="img-polaroid"/>-->
<!--                </div>-->
<!--                <div class="slide4">-->
<!--                    <img class="img-slider" src="img/slider/4.jpg" alt="" class="img-polaroid"/>-->
<!--                </div>-->
                <?php $no++;
                } ?>
                <?php } else {?>
        ...
        <div class="iklan-container" style="width: 610px; margin-top: 50px;">
            <h3>IKLAN TERBARU</h3>
            <hr>
            <?php
            ...
            if(!empty($iklan)) {?>
            <ul class="thumbnails">
                <?php foreach($iklan->result() as $data) {
                    if(is_premium($data->id_member)) {
                ?>

                <li style="float: left; width: 190px; height: 260px;" >
                    <div class="thumbnail">
                        <?php if(!empty($data->foto)) { ?>
                            <img src="<?php echo base_url();?>img_iklan/<?php echo $data->foto; ?>" alt="" class="img-iklan-item">
                        <?php } else { ?>
                            <img data-src="holder.js/175x150" alt="">
                        <?php } ?>
                        <p style="height: 70px; margin-top: 2px;">
                            <button class="btn btn-mini btn-info langganan" data-iklan="<?php echo $data->id_member; ?>" data-toggle="modal" data-target="#modlangganan">
                                <i class="icon-envelope"></i>
                            </button>
                            <a href="http://<?php echo $data->alamat_web; ?>" target="_blank" class="btn btn-mini btn-inverse"><i class="icon-cloud"></i></a>
            ...
            <hr>
            <p class="text-right link-premi">
                <a class="btn btn-large btn-info" href="<?php echo base_url();?>iklan/premium">lihat iklan premium</a>
            </p>
        </div>
...
<!--        <img src="holder.js/200x500" alt="" class="img-polaroid"/>-->
    ...
    <div class="banner-kanan">
        <?php if(!empty($iklan_kanan)) {
            if($iklan_kanan->disetujui == 1) {
                ?>
                <?php if(!empty($iklan_kanan->foto)) { ?>
                    <img src="<?php echo base_url();?>img_iklan/<?php echo $iklan_kanan->foto; ?>" alt="" class="img-polaroid img-kanan"/>
                <?php } else { ?>
                    <img src="holder.js/160x600" alt="" class="img-polaroid"/>
                <?php } ?>
            <?php } ?>
